...
if (+function (t) {
    ...
    function n(t, e, i, n, o, s) {
        return e && i ? '<div class="bootstrap-datetimepicker-widget dropdown-menu"><ul><li' + (s ? ' class="collapse in"' : "") + '><div class="datepicker">' + p.template + '</div></li><li class="picker-switch accordion-toggle"><a><i class="' + t + '"></i></a></li><li' + (s ? ' class="collapse"' : "") + '><div class="timepicker">' + f.getTemplate(n, o) + "</div></li></ul></div>" : i ? '<div class="bootstrap-datetimepicker-widget dropdown-menu"><div class="timepicker">' + f.getTemplate(n, o) + "</div></div>" : '<div class="bootstrap-datetimepicker-widget dropdown-menu"><div class="datepicker">' + p.template + "</div></div>"
    }
    ...
    s.prototype = {
        constructor: s, init: function (e, i) {
            ...
            t ? this._unset = !1 : this._unset = !0, "string" == typeof t ? this._date = this.parseDate(t) : t && (this._date = new Date(t)), this.set(), this.viewDate = o(this._date.getUTCFullYear(), this._date.getUTCMonth(), 1, 0, 0, 0, 0), this.fillDate(), this.fillTime()
        }, getDate: function () {
            return this._unset ? null : new Date(this._date.valueOf())
        }, setDate: function (t) {
            t ? this.setValue(t.valueOf()) : this.setValue(null)
        }, setStartDate: function (t) {
            t instanceof Date ? this.startDate = t : "string" == typeof t ? (this.startDate = new o(t), this.startDate.getUTCFullYear() || (this.startDate = -(1 / 0))) : this.startDate = -(1 / 0), this.viewDate && this.update()
        }, setEndDate: function (t) {
            t instanceof Date ? this.endDate = t : "string" == typeof t ? (this.endDate = new o(t), this.endDate.getUTCFullYear() || (this.endDate = 1 / 0)) : this.endDate = 1 / 0, this.viewDate && this.update()
            ...
            if (!e && (e = this.isInput ? this.$element.val() : this.$element.find("input").val(), e && (this._date = this.parseDate(e)), !this._date)) {
                var i = new Date;
                this._date = o(i.getFullYear(), i.getMonth(), i.getDate(), i.getHours(), i.getMinutes(), i.getSeconds(), i.getMilliseconds())
            }
            this.viewDate = o(this._date.getUTCFullYear(), this._date.getUTCMonth(), 1, 0, 0, 0, 0), this.fillDate(), this.fillTime()
        }, fillDow: function () {
            for (var e = this.weekStart, i = t("<tr>"); e < this.weekStart + 7;) i.append('<th class="dow">' + a[this.language].daysMin[e++ % 7] + "</th>");
            ...
            var e = this.viewDate.getUTCFullYear(), i = this.viewDate.getUTCMonth(),
                n = o(this._date.getUTCFullYear(), this._date.getUTCMonth(), this._date.getUTCDate(), 0, 0, 0, 0),
                s = "object" == typeof this.startDate ? this.startDate.getUTCFullYear() : -(1 / 0),
                r = "object" == typeof this.startDate ? this.startDate.getUTCMonth() : -1,
                l = "object" == typeof this.endDate ? this.endDate.getUTCFullYear() : 1 / 0,
                c = "object" == typeof this.endDate ? this.endDate.getUTCMonth() : 12;
            this.widget.find(".datepicker-days").find(".disabled").removeClass("disabled"), this.widget.find(".datepicker-months").find(".disabled").removeClass("disabled"), this.widget.find(".datepicker-years").find(".disabled").removeClass("disabled"), this.widget.find(".datepicker-days th:eq(1)").text(a[this.language].months[i] + " " + e);
            var d = o(e, i - 1, 28, 0, 0, 0, 0), h = p.getDaysInMonth(d.getUTCFullYear(), d.getUTCMonth());
            d.setUTCDate(h), d.setUTCDate(h - (d.getUTCDay() - this.weekStart + 7) % 7), (e == s && i <= r || e < s) && this.widget.find(".datepicker-days th:eq(0)").addClass("disabled"), (e == l && i >= c || e > l) && this.widget.find(".datepicker-days th:eq(2)").addClass("disabled");
            var u = new Date(d.valueOf());
            u.setUTCDate(u.getUTCDate() + 42), u = u.valueOf();
            for (var f, m, g = []; d.valueOf() < u;) d.getUTCDay() === this.weekStart && (f = t("<tr>"), g.push(f)), m = "", d.getUTCFullYear() < e || d.getUTCFullYear() == e && d.getUTCMonth() < i ? m += " old" : (d.getUTCFullYear() > e || d.getUTCFullYear() == e && d.getUTCMonth() > i) && (m += " new"), d.valueOf() === n.valueOf() && (m += " active"), d.valueOf() + 864e5 <= this.startDate && (m += " disabled"), d.valueOf() > this.endDate && (m += " disabled"), f.append('<td class="day' + m + '">' + d.getUTCDate() + "</td>"), d.setUTCDate(d.getUTCDate() + 1);
            this.widget.find(".datepicker-days tbody").empty().append(g);
            var v = this._date.getUTCFullYear(),
                y = this.widget.find(".datepicker-months").find("th:eq(1)").text(e).end().find("span").removeClass("active");
            v === e && y.eq(this._date.getUTCMonth()).addClass("active"), v - 1 < s && this.widget.find(".datepicker-months th:eq(0)").addClass("disabled"), v + 1 > l && this.widget.find(".datepicker-months th:eq(2)").addClass("disabled");
            for (var b = 0; b < 12; b++) e == s && r > b || e < s ? t(y[b]).addClass("disabled") : (e == l && c < b || e > l) && t(y[b]).addClass("disabled");
            g = "", e = 10 * parseInt(e / 10, 10);
            var w = this.widget.find(".datepicker-years").find("th:eq(1)").text(e + "-" + (e + 9)).end().find("td");
            this.widget.find(".datepicker-years").find("th").removeClass("disabled"), s > e && this.widget.find(".datepicker-years").find("th:eq(0)").addClass("disabled"), l < e + 9 && this.widget.find(".datepicker-years").find("th:eq(2)").addClass("disabled"), e -= 1;
            for (var b = -1; b < 11; b++) g += '<span class="year' + (b === -1 || 10 === b ? " old" : "") + (v === e ? " active" : "") + (e < s || e > l ? " disabled" : "") + '">' + e + "</span>", e += 1;
            w.html(g)
        }, fillHours: function () {
            var t = this.widget.find(".timepicker .timepicker-hours table");
            t.parent().hide();
            var e = "";
            if (this.options.pick12HourFormat) for (var n = 1, o = 0; o < 3; o += 1) {
                e += "<tr>";
                for (var s = 0; s < 4; s += 1) {
                    var r = n.toString();
                    e += '<td class="hour">' + i(r, 2, "0") + "</td>", n++
                }
                e += "</tr>"
            } else for (var n = 0, o = 0; o < 6; o += 1) {
                e += "<tr>";
                for (var s = 0; s < 4; s += 1) {
                    var r = n.toString();
                    e += '<td class="hour">' + i(r, 2, "0") + "</td>", n++
            ...
            t.parent().hide();
            for (var e = "", n = 0, o = 0; o < 5; o++) {
                e += "<tr>";
                for (var s = 0; s < 4; s += 1) {
                    var r = n.toString();
                    e += '<td class="minute">' + i(r, 2, "0") + "</td>", n += 3
                }
                e += "</tr>"
            }
            t.html(e)
            ...
            for (var e = "", n = 0, o = 0; o < 5; o++) {
                ...
                for (var s = 0; s < 4; s += 1) {
                    var r = n.toString();
                    e += '<td class="second">' + i(r, 2, "0") + "</td>", n += 3
                }
                e += "</tr>"
            }
            t.html(e)
            ...
            if (this._date) {
                var t = this.widget.find(".timepicker span[data-time-component]"),
                    e = (t.closest("table"), this.options.pick12HourFormat), n = this._date.getUTCHours(), o = "AM";
                e && (n >= 12 && (o = "PM"), 0 === n ? n = 12 : 12 != n && (n %= 12), this.widget.find(".timepicker [data-action=togglePeriod]").text(o)), n = i(n.toString(), 2, "0");
                var s = i(this._date.getUTCMinutes().toString(), 2, "0"),
                    r = i(this._date.getUTCSeconds().toString(), 2, "0");
                t.filter("[data-time-component=hours]").text(n), t.filter("[data-time-component=minutes]").text(s), t.filter("[data-time-component=seconds]").text(r)
            }
        }, click: function (e) {
            ...
            if (1 === i.length && !i.is(".disabled")) switch (i[0].nodeName.toLowerCase()) {
                case"th":
                    switch (i[0].className) {
                        ...
                        case"prev":
                        case"next":
                            var n = this.viewDate, s = p.modes[this.viewMode].navFnc,
                                r = p.modes[this.viewMode].navStep;
                            "prev" === i[0].className && (r *= -1), n["set" + s](n["get" + s]() + r), this.fillDate(), this.set()
                    }
                    break;
                case"span":
                    if (i.is(".month")) {
                    ...
                    0 !== this.viewMode && (this._date = o(this.viewDate.getUTCFullYear(), this.viewDate.getUTCMonth(), this.viewDate.getUTCDate(), this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds()), this.notifyChange()), this.showMode(-1), this.fillDate(), this.set();
                    break;
                case"td":
                    if (i.is(".day")) {
                        var c = parseInt(i.text(), 10) || 1, a = this.viewDate.getUTCMonth(),
                            l = this.viewDate.getUTCFullYear();
                        i.is(".old") ? 0 === a ? (a = 11, l -= 1) : a -= 1 : i.is(".new") && (11 == a ? (a = 0, l += 1) : a += 1), this._date = o(l, a, c, this._date.getUTCHours(), this._date.getUTCMinutes(), this._date.getUTCSeconds(), this._date.getUTCMilliseconds()), this.viewDate = o(l, a, Math.min(28, c), 0, 0, 0, 0), this.fillDate(), this.set(), this.notifyChange()
                    }
            }
        }, actions: {
            incrementHours: function (t) {
                ...
                if (this.options.pick12HourFormat) {
                    var o = this._date.getUTCHours();
                    o >= 12 ? 12 != n && (n = (n + 12) % 24) : 12 === n ? n = 0 : n %= 12
                }
            ...
            e.stopPropagation(), e.preventDefault(), this._date || (this._date = o(1970, 0, 0, 0, 0, 0, 0));
            ...
            var i = this, n = e.which, o = t(e.target);
            ...
            var i = e.which;
            if (8 != i && 46 != i) {
                var n = t(e.target), o = String.fromCharCode(i), s = n.val() || "";
                s += o;
                var r = this._mask[this._maskPos];
                if (!r) return !1;
                if (r.end == s.length) {
                    if (!r.pattern.test(s.slice(r.start))) {
                        for (s = s.slice(0, s.length - 1); (r = this._mask[this._maskPos]) && r.character;) s += r.character, this._maskPos++;
                        return s += o, r.end != s.length ? (n.val(s), !1) : r.pattern.test(s.slice(r.start)) ? (n.val(s), this._maskPos++, !1) : (n.val(s.slice(0, r.start)), !1)
                    }
                    this._maskPos++
                }
            }
            ...
            return this.format.replace(u, function (e) {
                var n, o, s, r = e.length;
                if ("ms" === e && (r = 1), o = l[e].property, "Hours12" === o) s = t.getUTCHours(), 0 === s ? s = 12 : 12 !== s && (s %= 12); else {
                    if ("Period12" === o) return t.getUTCHours() >= 12 ? "PM" : "AM";
                    n = "get" + o, s = t[n]()
                }
                return "getUTCMonth" === n && (s += 1), "getUTCYear" === n && (s = s + 1900 - 2e3), i(s.toString(), r, "0")
            })
        }, parseDate: function (t) {
            var e, i, n, o, s = {};
            if (!(e = this._formatPattern.exec(t))) return null;
            for (i = 1; i < e.length; i++) n = this._propertiesByIndex[i], n && (o = e[i], /^\d+$/.test(o) && (o = parseInt(o, 10)), s[n] = o);
            return this._finishParsingDate(s)
            ...
            var e, i, n, s, r, a, l;
            return e = t.UTCFullYear, t.UTCYear && (e = 2e3 + t.UTCYear), e || (e = 1970), i = t.UTCMonth ? t.UTCMonth - 1 : 0, n = t.UTCDate || 1, s = t.UTCHours || 0, r = t.UTCMinutes || 0, a = t.UTCSeconds || 0, l = t.UTCMilliseconds || 0, t.Hours12 && (s = t.Hours12), t.Period12 && (/pm/i.test(t.Period12) ? 12 != s && (s = (s + 12) % 24) : s %= 12), o(e, i, n, s, r, a, l)
        }, _compileFormat: function () {
            for (var t, i, n = [], o = [], s = this.format, r = {}, a = 0, c = 0; t = h.exec(s);) i = t[0], i in l ? (a++, r[a] = l[i].property, n.push("\\s*" + l[i].getPattern(this) + "\\s*"), o.push({
            ...
            this._mask = o, this._maskPos = 0, this._formatPattern = new RegExp("^\\s*" + n.join("") + "\\s*$"), this._propertiesByIndex = r
            ...
            this.widget.on("click", ".datepicker *", t.proxy(this.click, this)), this.widget.on("click", "[data-action]", t.proxy(this.doAction, this)), this.widget.on("mousedown", t.proxy(this.stopEvent, this)), this.pickDate && this.pickTime && this.widget.on("click.togglePicker", ".accordion-toggle", function (i) {
                i.stopPropagation();
                var n = t(this), o = n.closest("ul"), s = o.find(".collapse.in"), r = o.find(".collapse:not(.in)");
                if (s && s.length) {
                    var a = s.data("collapse");
                    if (a && a.transitioning) return;
                    s.collapse("hide"), r.collapse("show"), n.find("i").toggleClass(e.timeIcon + " " + e.dateIcon), e.$element.find(".add-on i").toggleClass(e.timeIcon + " " + e.dateIcon)
                }
        ...
        return this.each(function () {
            var n = t(this), o = n.data("datetimepicker"), r = "object" == typeof e && e;
            o || n.data("datetimepicker", o = new s(this, t.extend({}, t.fn.datetimepicker.defaults, r))), "string" == typeof e && o[e](i)
        })
        ...
        endDate: 1 / 0,
        collapse: !0
    }, t.fn.datetimepicker.Constructor = s;
    var r = 0, a = t.fn.datetimepicker.dates = {
        en: {
    ...
    for (var d in l) c.push(d);
    c[c.length - 1] += "\\b", c.push(".");
    var h = new RegExp(c.join("\\b|"));
    c.pop();
    var u = new RegExp(c.join("\\b|"), "g"), p = {
...
if (+function (t) {
    ...
    i.VERSION = "3.3.7", i.DEFAULTS = {loadingText: "loading..."}, i.prototype.setState = function (e) {
        ...
        e += "Text", null == s.resetText && n.data("resetText", n[o]()),
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        var c = s[0], d = t.Event("slide.bs.carousel", {relatedTarget: c, direction: a});
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        var h = /top|bottom/.test(i), u = h ? 2 * d.left - o + l : 2 * d.top - s + c,
...
+function (t) {
    ...
    jQuery(document).ready(function () {
        t("#cform2").submit(function () {
            var e = t(this).attr("action");
            return t("#message2").slideUp(750, function () {
                t("#message2").hide(), t("#submit").before('<img src="images/ajax-loader.gif" class="contact-loader" />').attr("disabled", "disabled"), t.post(e, {
                    name: t("#name2").val(),
                    email: t("#email2").val(),
                    skype: t("#skype2").val(),
                    comments: t("#user_phone2").val()
                }, function (e) {
                    return "success" == e ? void (location.href = "./zayavka.html") : (document.getElementById("message2").innerHTML = e, t("#message2").slideDown("slow"), t("#submit").removeAttr("disabled"), void (null != e.match("success") && t("#cform2").slideUp("slow")))
                })
            }), !1
        }), t("#cform").submit(function () {
            var e = t(this).attr("action");
            return t("#message").slideUp(750, function () {
                t("#message").hide(), t("#submit").before('<img src="images/ajax-loader.gif" class="contact-loader" />').attr("disabled", "disabled"), t.post(e, {
                    name: t("#name").val(),
                    email: t("#email").val(),
                    skype: t("#skype").val(),
                    comments: t("#user_phone").val()
                }, function (e) {
                    return "success" == e ? void (location.href = "./zayavka.html") : (document.getElementById("message").innerHTML = e, t("#message").slideDown("slow"), t("#submit").removeAttr("disabled"), void (null != e.match("success") && t("#cform").slideUp("slow")))
                })
            }), !1
        })
    })
    ...
    }, l = navigator.userAgent.match(/msie/i), c = null, d = e.createTouch !== n, h = function (t) {
    ...
    i.extend(a, {
        ...
        open: function (t, e) {
            if (t && (i.isPlainObject(e) || (e = {}), !1 !== a.close(!0))) return i.isArray(t) || (t = h(t) ? i(t).get() : [t]), i.each(t, function (o, s) {
                var r, l, c, d, p, f = {};
                "object" === i.type(s) && (s.nodeType && (s = i(s)), h(s) ? (f = {
                    href: s.data("fancybox-href") || s.attr("href"),
                    title: s.data("fancybox-title") || s.attr("title"),
                    isDom: !0,
                    element: s
                }, i.metadata && i.extend(!0, f, s.metadata())) : f = s), r = e.href || f.href || (u(s) ? s : null), l = e.title !== n ? e.title : f.title || "", d = (c = e.content || f.content) ? "html" : e.type || f.type, !d && f.isDom && (d = s.data("fancybox-type"), d || (d = (d = s.prop("class").match(/fancybox\.(\w+)/)) ? d[1] : null)), u(r) && (d || (a.isImage(r) ? d = "image" : a.isSWF(r) ? d = "swf" : "#" === r.charAt(0) ? d = "inline" : u(s) && (d = "html", c = s)), "ajax" === d && (p = r.split(/\s+/, 2), r = p.shift(), p = p.shift())), c || ("inline" === d ? r ? c = i(u(r) ? r.replace(/.*(?=#[^\s]+$)/, "") : r) : f.isDom && (c = s) : "html" === d ? c = r : !d && !r && f.isDom && (d = "inline", c = s)), i.extend(f, {
                    href: r,
                    type: d,
                    content: c,
                    title: l,
        ...
        getViewport: function () {
            ...
            return e ? (i.w = e[0].clientWidth, i.h = e[0].clientHeight) : (i.w = d && t.innerWidth ? t.innerWidth : s.width(), i.h = d && t.innerHeight ? t.innerHeight : s.height()), i
        },
        ...
        bindEvents: function () {
            var t, e = a.current;
            e && (s.bind("orientationchange.fb" + (d ? "" : " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb" : ""), a.update), (t = e.keys) && r.bind("keydown.fb", function (o) {
        ...
        _setDimension: function () {
            var t, e, n, o, s, r, l, c, d, h = a.getViewport(), u = 0, g = !1, v = !1, g = a.wrap, y = a.skin,
                b = a.inner, w = a.current, v = w.width, x = w.height, C = w.minWidth, T = w.minHeight, k = w.maxWidth,
                _ = w.maxHeight, $ = w.scrolling, E = w.scrollOutside ? w.scrollbarWidth : 0, S = w.margin,
                D = f(S[1] + S[3]), A = f(S[0] + S[2]);
            if (g.add(y).add(b).width("auto").height("auto").removeClass("fancybox-tmp"), S = f(y.outerWidth(!0) - y.width()), t = f(y.outerHeight(!0) - y.height()), e = D + S, n = A + t, o = p(v) ? (h.w - e) * f(v) / 100 : v, s = p(x) ? (h.h - n) * f(x) / 100 : x, "iframe" === w.type) {
                if (d = w.content, w.autoHeight && 1 === d.data("ready")) try {
                    d[0].contentWindow.document.location && (b.width(o).height(9999), r = d.contents().find("body"), E && r.css("overflow-x", "hidden"), s = r.outerHeight(!0))
                } catch (t) {
                }
            ...
            if (v = f(o), x = f(s), c = o / s, C = f(p(C) ? f(C, "w") - e : C), k = f(p(k) ? f(k, "w") - e : k), T = f(p(T) ? f(T, "h") - n : T), _ = f(p(_) ? f(_, "h") - n : _), r = k, l = _, w.fitToView && (k = Math.min(h.w - e, k), _ = Math.min(h.h - n, _)), e = h.w - D, A = h.h - A, w.aspectRatio ? (v > k && (v = k, x = f(v / c)), x > _ && (x = _, v = f(x * c)), v < C && (v = C, x = f(v / c)), x < T && (x = T, v = f(x * c))) : (v = Math.max(C, Math.min(v, k)), w.autoHeight && "iframe" !== w.type && (b.width(v), x = b.height()), x = Math.max(T, Math.min(x, _))), w.fitToView) if (b.width(v).height(x), g.width(v + S), h = g.width(), D = g.height(), w.aspectRatio) for (; (h > e || D > A) && v > C && x > T && !(19 < u++);) x = Math.max(T, Math.min(_, x - 10)), v = f(x * c), v < C && (v = C, x = f(v / c)), v > k && (v = k, x = f(v / c)), b.width(v).height(x), g.width(v + S), h = g.width(), D = g.height(); else v = Math.max(C, Math.min(v, v - (h - e))), x = Math.max(T, Math.min(x, x - (D - A)));
            E && "auto" === $ && x < s && v + S + E < e && (v += E), b.width(v).height(x), g.width(v + S), h = g.width(), D = g.height(), g = (h > e || D > A) && v > C && x > T, v = w.aspectRatio ? v < r && x < l && v < o && x < s : (v < r || x < l) && (v < o || x < s), i.extend(w, {
                dim: {
                    width: m(h),
                    height: m(D)
                },
            ...
            }), !d && w.autoHeight && x > T && x < _ && !v && b.height("auto")
        },
        ...
        var e, n = i(this), o = this.selector || "", s = function (s) {
            ...
            !s.ctrlKey && !s.altKey && !s.shiftKey && !s.metaKey && !c.is(".fancybox-wrap") && (r = t.groupAttr || "data-fancybox-group", l = c.attr(r), l || (r = "rel", l = c.get(0)[r]), l && "" !== l && "nofollow" !== l && (c = o.length ? i(o) : n, c = c.filter("[" + r + '="' + l + '"]'), d = c.index(this)), t.index = d, !1 !== a.open(c, t) && s.preventDefault())
        };
    ...
    var e, i, n, o, s, r, a = "Close", l = "BeforeClose", c = "AfterClose", d = "BeforeAppend", h = "MarkupParse",
        u = "Open", p = "Change", f = "mfp", m = "." + f, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close",
        b = function () {
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0 ? e.content.find(".mfp-close").length || e.content.append(_()) : e.content = t : e.content = "", k(d), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        }, parseEl: function (i) {
            var n, o = e.items[i];
    ...
    var S, D, A, I = "inline", N = function () {
        A && (D.after(A.addClass(S)).detach(), A = null)
    };
            ...
            initInline: function () {
                ...
                if (N(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (D || (S = o.hiddenClass, D = T(S), S = "mfp-" + S), A = s.after(D).detach().removeClass(S)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(O, {
        options: {
            ...
            initAjax: function () {
                e.types.push(O), F = e.st.ajax.cursor, C(a + "." + O, P), C("BeforeChange." + O, P)
            }, getAjax: function (i) {
                F && t(document.body).addClass(F), e.updateStatus("loading");
                var n = t.extend({
                    url: i.src, success: function (n, o, s) {
                        var r = {data: n, xhr: s};
                        k("ParseAjax", r), e.appendContent(t(r.data), O), i.finished = !0, j(), e._setFocus(), setTimeout(function () {
                            e.wrap.addClass(g)
    ...
    t.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                e.types.push("image"), C(u + n, function () {
                ...
                var o = 0, s = function () {
                    i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, k("ImageLoadComplete")) : (o++, o < 200 ? setTimeout(s, 100) : r()))
                }, r = function () {
    ...
    var H = "iframe", U = "//about:blank", W = function (t) {
        if (e.currTemplate[H]) {
            ...
            i.length && (t || (i[0].src = U), e.isIE8 && i.css("display", t ? "block" : "none"))
        }
    };
    ...
    t.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                return e.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", C(u + o, function () {
    ...
    var i, n = e() + ".mask", o = navigator.userAgent, s = /iphone/i.test(o), r = /android/i.test(o);
    t.mask = {
        ...
        caret: function (t, e) {
            ...
            var a, l, c, d, h, u;
            return !e && this.length > 0 ? (a = t(this[0]), a.data(t.mask.dataName)()) : (o = t.extend({
                placeholder: t.mask.placeholder,
                completed: null
            }, o), l = t.mask.definitions, c = [], d = u = e.length, h = null, t.each(e.split(""), function (t, e) {
                "?" == e ? (u--, d = t) : l[e] ? (c.push(RegExp(l[e])), null === h && (h = c.length - 1)) : c.push(null)
                ...
                function f(t, e) {
                    var i, n;
                    if (!(0 > t)) {
                        for (i = t, n = a(e); u > i; i++) if (c[i]) {
                            if (!(u > n && c[i].test(C[n]))) break;
                            C[i] = C[n], C[n] = o.placeholder, n = a(n)
                        }
                        b(), x.caret(Math.max(h, t))
                    }
                }

                function m(t) {
                    var e, i, n, s;
                    for (e = t, i = o.placeholder; u > e; e++) if (c[e]) {
                        if (n = a(e), s = C[e], C[e] = i, !(u > n && c[n].test(s))) break;
                        i = s
                    }
                }
                ...
                function g(t) {
                    var e, i, n, o = t.which;
                    8 === o || 46 === o || s && 127 === o ? (e = x.caret(), i = e.begin, n = e.end, 0 === n - i && (i = 46 !== o ? p(i) : n = a(i - 1), n = 46 === o ? a(n) : n), y(i, n), f(i, n - 1), t.preventDefault()) : 27 == o && (x.val(T), x.caret(0, w()), t.preventDefault())
                }

                function v(e) {
                    var i, n, s, l = e.which, d = x.caret();
                    e.ctrlKey || e.altKey || e.metaKey || 32 > l || l && (0 !== d.end - d.begin && (y(d.begin, d.end), f(d.begin, d.end - 1)), i = a(d.begin - 1), u > i && (n = String.fromCharCode(l), c[i].test(n) && (m(i), C[i] = n, b(), s = a(i), r ? setTimeout(t.proxy(t.fn.caret, x, s), 0) : x.caret(s), o.completed && s >= u && o.completed.call(x))), e.preventDefault())
                }

                function y(t, e) {
                    var i;
                    for (i = t; e > i && u > i; i++) c[i] && (C[i] = o.placeholder)
                }
                ...
                function w(t) {
                    var e, i, n = x.val(), s = -1;
                    for (e = 0, pos = 0; u > e; e++) if (c[e]) {
                        for (C[e] = o.placeholder; pos++ < n.length;) if (i = n.charAt(pos - 1), c[e].test(i)) {
                            C[e] = i, s = e;
                            break
                        }
                        if (pos > n.length) break
                    } else C[e] === n.charAt(pos) && e !== d && (pos++, s = e);
                    return t ? b() : d > s + 1 ? (x.val(""), y(0, u)) : (b(), x.val(x.val().substring(0, s + 1))), d ? e : h
                }

                var x = t(this), C = t.map(e.split(""), function (t) {
                    return "?" != t ? l[t] ? o.placeholder : t : void 0
                }), T = x.val();
                x.data(t.mask.dataName, function () {
                    return t.map(C, function (t, e) {
                        return c[e] && t != o.placeholder ? t : null
                    }).join("")
                    ...
                    clearTimeout(i);
                    var t;
                    T = x.val(), t = w(), i = setTimeout(function () {
                        b(), t == e.length ? x.caret(0, t) : x.caret(t)
                    }, 10)
                    ...
                    setTimeout(function () {
                        var t = w(!0);
                        x.caret(t), o.completed && t == x.val().length && o.completed.call(x)
                    }, 0)
                }), w()
            }))
        }
    ...
    function l(t, e, i) {
        if (void 0 === i && 1 === t.nodeType) {
            var n = "data-" + e.replace(_t, "-$1").toLowerCase();
    ...
    function d(t, e, i, n) {
        if (ot.acceptData(t)) {
            ...
            if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = a ? t[r] = Y.pop() || ot.guid++ : r), l[c] || (l[c] = a ? {} : {toJSON: ot.noop}), ("object" == typeof e || "function" == typeof e) && (n ? l[c] = ot.extend(l[c], e) : l[c].data = ot.extend(l[c].data, e)), s = l[c], n || (s.data || (s.data = {}), s = s.data), void 0 !== i && (s[ot.camelCase(e)] = i), "string" == typeof e ? (o = s[e], null == o && (o = s[ot.camelCase(e)])) : o = s, o
        }
    }
    ...
    function m(t) {
        var e = Pt.split("|"), i = t.createDocumentFragment();
    ...
    function C(t, e) {
        if (1 === e.nodeType && ot.hasData(t)) {
            ...
            if (a) {
                ...
                for (i in a) for (n = 0, o = a[i].length; o > n; n++) ot.event.add(e, i, a[i][n])
            }
    ...
    function T(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            "script" === i && e.text !== t.text ? (b(e).text = t.text, w(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), it.html5Clone && t.innerHTML && !ot.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && At.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === i || "textarea" === i) && (e.defaultValue = t.defaultValue)
        }
    }
    ...
    function _(t) {
        var e = ft, i = Jt[t];
        return i || (i = k(t, e), "none" !== i && i || (Gt = (Gt || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Gt[0].contentWindow || Gt[0].contentDocument).document, e.write(), e.close(), i = k(t, e), Gt.detach()), Jt[t] = i), i
    }
    ...
    function E(t, e) {
        if (e in t) return e;
        for (var i = e.charAt(0).toUpperCase() + e.slice(1), n = e, o = ue.length; o--;) if (e = ue[o] + i, e in t) return e;
        return n
    }

    function S(t, e) {
        for (var i, n, o, s = [], r = 0, a = t.length; a > r; r++) n = t[r], n.style && (s[r] = ot._data(n, "olddisplay"), i = n.style.display, e ? (s[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && St(n) && (s[r] = ot._data(n, "olddisplay", _(n.nodeName)))) : (o = St(n), (i && "none" !== i || !o) && ot._data(n, "olddisplay", o ? i : ot.css(n, "display"))));
    ...
    function A(t, e, i, n, o) {
        for (var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > s; s += 2) "margin" === i && (r += ot.css(t, i + Et[s], !0, o)), n ? ("content" === i && (r -= ot.css(t, "padding" + Et[s], !0, o)), "margin" !== i && (r -= ot.css(t, "border" + Et[s] + "Width", !0, o))) : (r += ot.css(t, "padding" + Et[s], !0, o), "padding" !== i && (r += ot.css(t, "border" + Et[s] + "Width", !0, o)));
        return r
    }
    ...
    function O(t, e) {
        ...
        for (e = e ? 1 : 0; 4 > o; o += 2 - e) i = Et[o], n["margin" + i] = n["padding" + i] = t;
        return e && (n.opacity = n.width = t), n
    }

    function j(t, e, i) {
        for (var n, o = (be[e] || []).concat(be["*"]), s = 0, r = o.length; r > s; s++) if (n = o[s].call(i, e, t)) return n
    }

    function P(t, e, i) {
        var n, o, s, r, a, l, c, d, h = this, u = {}, p = t.style, f = t.nodeType && St(t), m = ot._data(t, "fxshow");
        ...
        })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], c = ot.css(t, "display"), d = "none" === c ? ot._data(t, "olddisplay") || _(t.nodeName) : c, "inline" === d && "none" === ot.css(t, "float") && (it.inlineBlockNeedsLayout && "inline" !== _(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), i.overflow && (p.overflow = "hidden", it.shrinkWrapBlocks() || h.always(function () {
            p.overflow = i.overflow[0], p.overflowX = i.overflow[1], p.overflowY = i.overflow[2]
        }));
        for (n in e) if (o = e[n], me.exec(o)) {
        ...
        if (ot.isEmptyObject(u)) "inline" === ("none" === c ? _(t.nodeName) : c) && (p.display = c); else {
            ...
            for (n in u) r = j(f ? m[n] : 0, n, h), n in m || (m[n] = r.start, f && (r.end = r.start, r.start = "width" === n || "height" === n ? 1 : 0))
        }
    }
    ...
    function R(t, e, i) {
        var n, o, s = 0, r = ye.length, a = ot.Deferred().always(function () {
            ...
            if (o) return !1;
            for (var e = pe || F(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, s = 1 - n, r = 0, l = c.tweens.length; l > r; r++) c.tweens[r].run(s);
        ...
        for (L(d, c.opts.specialEasing); r > s; s++) if (n = ye[s].call(c, t, d, c.opts)) return n;
        return ot.map(d, j, c), ot.isFunction(c.opts.start) && c.opts.start.call(t, c), ot.fx.timer(ot.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
    ...
    function B(t, e, i, n) {
        ...
        if (ot.isArray(e)) ot.each(e, function (e, o) {
            i || Ve.test(t) ? n(t, o) : B(t + "[" + ("object" == typeof o ? e : "") + "]", o, i, n)
        }); else if (i || "object" !== ot.type(e)) n(t, e); else for (o in e) B(t + "[" + o + "]", e[o], i, n)
    }
    ...
    var Y = [], X = Y.slice, K = Y.concat, Z = Y.push, G = Y.indexOf, J = {}, tt = J.toString, et = J.hasOwnProperty,
        it = {}, nt = "1.11.3", ot = function (t, e) {
    ...
    ot.fn = ot.prototype = {
        ...
        for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || ot.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++) if (null != (o = arguments[a])) for (n in o) t = r[n], i = o[n], r !== i && (c && i && (ot.isPlainObject(i) || (e = ot.isArray(i))) ? (e ? (e = !1, s = t && ot.isArray(t) ? t : []) : s = t && ot.isPlainObject(t) ? t : {}, r[n] = ot.extend(c, s, i)) : void 0 !== i && (r[n] = i));
        return r
    }, ot.extend({
    ...
    var ct = function (t) {
        function e(t, e, i, n) {
            ...
            if ((e ? e.ownerDocument || e : z) !== N && I(e), e = e || N, i = i || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return i;
            if (!n && O) {
                if (11 !== a && (o = yt.exec(t))) if (r = o[1]) {
                    if (9 === a) {
                        if (s = e.getElementById(r), !s || !s.parentNode) return i;
                        if (s.id === r) return i.push(s), i
                    } else if (e.ownerDocument && (s = e.ownerDocument.getElementById(r)) && R(e, s) && s.id === r) return i.push(s), i
                } else {
                    if (o[2]) return G.apply(i, e.getElementsByTagName(t)), i;
                    if ((r = o[3]) && x.getElementsByClassName) return G.apply(i, e.getElementsByClassName(r)), i
                }
                if (x.qsa && (!j || !j.test(t))) {
                    if (p = h = M, f = e, m = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (c = _(t), (h = e.getAttribute("id")) ? p = h.replace(wt, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + u(c[l]);
        ...
        function p(t, e, i) {
            var n = e.dir, o = i && "parentNode" === n, s = U++;
            return e.first ? function (e, i, s) {
                ...
                if (r) {
                    ...
                    if (l = e[M] || (e[M] = {}), (a = l[n]) && a[0] === H && a[1] === s) return c[2] = a[2];
        ...
        function v(t, e, i, o, s, r) {
            return o && !o[M] && (o = v(o)), s && !s[M] && (s = v(s, r)), n(function (n, r, a, l) {
                var c, d, h, u = [], p = [], f = r.length, v = n || m(e || "*", a.nodeType ? [a] : a, []),
                    y = !t || !n && e ? v : g(v, u, t, a, l), b = i ? s || (n ? t : f || o) ? [] : r : y;
                if (i && i(y, b, a, l), o) for (c = g(b, p), o(c, [], a, l), d = c.length; d--;) (h = c[d]) && (b[p[d]] = !(y[p[d]] = h));
                if (n) {
                    if (s || t) {
                        if (s) {
        ...
        function y(t) {
            for (var e, i, n, o = t.length, s = C.relative[t[0].type], r = s || C.relative[" "], a = s ? 1 : 0, l = p(function (t) {
                ...
                return e = null, o
            }]; o > a; a++) if (i = C.relative[t[a].type]) d = [p(f(d), i)]; else {
                if (i = C.filter[t[a].type].apply(null, t[a].matches), i[M]) {
                    for (n = ++a; o > n && !C.relative[t[n].type]; n++) ;
                    return v(a > 1 && f(d), a > 1 && u(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(lt, "$1"), i, n > a && y(t.slice(a, n)), o > n && y(t = t.slice(n)), o > n && u(t))
                }
                d.push(i)
            }
            return f(d)
        ...
        function b(t, i) {
            var o = i.length > 0, s = t.length > 0, r = function (n, r, a, l, c) {
                var d, h, u, p = 0, f = "0", m = n && [], v = [], y = S, b = n || s && C.find.TAG("*", c),
                    w = H += null == y ? 1 : Math.random() || .1, x = b.length;
                for (c && (S = r !== N && r); f !== x && null != (d = b[f]); f++) {
                    if (s && d) {
                        for (h = 0; u = t[h++];) if (u(d, r, a)) {
                            l.push(d);
                            break
                        }
                        c && (H = w)
        ...
        var w, x, C, T, k, _, $, E, S, D, A, I, N, F, O, j, P, L, R, M = "sizzle" + 1 * new Date, z = t.document, H = 0,
            U = 0, W = i(), B = i(), q = i(), V = function (t, e) {
                return t === e && (A = !0), 0
            }, Q = 1 << 31, Y = {}.hasOwnProperty, X = [], K = X.pop, Z = X.push, G = X.push, J = X.slice,
            tt = function (t, e) {
            ...
            ht = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]", "g"), ut = new RegExp(rt),
            pt = new RegExp("^" + ot + "$"), ft = {
                ID: new RegExp("^#(" + nt + ")"),
                CLASS: new RegExp("^\\.(" + nt + ")"),
            ...
            yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, wt = /'|\\/g,
            xt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)", "ig"), Ct = function (t, e, i) {
                var n = "0x" + e - 65536;
        ...
        x = e.support = {}, k = e.isXML = function (t) {
            ...
            return n !== N && 9 === n.nodeType && n.documentElement ? (N = n, F = n.documentElement, i = n.defaultView, i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", Tt, !1) : i.attachEvent && i.attachEvent("onunload", Tt)), O = !k(n), x.attributes = o(function (t) {
            ...
            }, P = [], j = [], (x.qsa = vt.test(n.querySelectorAll)) && (o(function (t) {
            ...
            })), (x.matchesSelector = vt.test(L = F.matches || F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && o(function (t) {
                x.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), P.push("!=", rt)
            }), j = j.length && new RegExp(j.join("|")), P = P.length && new RegExp(P.join("|")), e = vt.test(F.compareDocumentPosition), R = e || vt.test(F.contains) ? function (t, e) {
                ...
                return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !x.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === z && R(z, t) ? -1 : e === n || e.ownerDocument === z && R(z, e) ? 1 : D ? tt(D, t) - tt(D, e) : 0 : 4 & i ? -1 : 1)
            } : function (t, e) {
                if (t === e) return A = !0, 0;
            ...
            if ((t.ownerDocument || t) !== N && I(t), i = i.replace(ht, "='$1']"), x.matchesSelector && O && (!P || !P.test(i)) && (!j || !j.test(i))) try {
                var n = L.call(t, i);
            ...
            var i = C.attrHandle[e.toLowerCase()],
                n = i && Y.call(C.attrHandle, e.toLowerCase()) ? i(t, e, !O) : void 0;
            ...
            preFilter: {
                ATTR: function (t) {
                    ...
                    var e, i = !t[6] && t[2];
                    return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ut.test(i) && (e = _(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === n && 0 === o ? function (t) {
                        ...
                        if (g) {
                            ...
                            if (f = [r ? g.firstChild : g.lastChild], r && y) {
                                for (d = g[M] || (g[M] = {}), c = d[t] || [], p = c[0] === H && c[1], u = c[0] === H && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (u = p = 0) || f.pop();) if (1 === h.nodeType && ++u && h === e) {
                                    d[t] = [H, p, u];
                                    break
                                }
                            } else if (y && (c = (e[M] || (e[M] = {}))[t]) && c[0] === H) u = c[1]; else for (; (h = ++p && h && h[m] || (u = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++u || (y && ((h[M] || (h[M] = {}))[t] = [H, u]), h !== e));) ;
                            return u -= o, u === n || u % n === 0 && u / n >= 0
                        }
                    }
                }, PSEUDO: function (t, i) {
                    var o, s = C.pseudos[t] || C.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                    return s[M] ? s(i) : s.length > 1 ? (o = [t, t, "", i], C.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
            ...
            pseudos: {
                not: n(function (t) {
                    var e = [], i = [], o = $(t.replace(lt, "$1"));
                    return o[M] ? n(function (t, e, i, n) {
                        for (var s, r = o(t, null, n, []), a = t.length; a--;) (s = r[a]) && (t[a] = !(e[a] = s))
                    }) : function (t, n, s) {
                        return e[0] = t,
                            o(e, null, s, i), e[0] = null, !i.pop()
                    }
                }), has: n(function (t) {
                    return function (i) {
        ...
        return h.prototype = C.filters = C.pseudos, C.setFilters = new h, _ = e.tokenize = function (t, i) {
            var n, o, s, r, a, l, c, d = B[t + " "];
            ...
            var i, n = [], o = [], s = q[t + " "];
            if (!s) {
                for (e || (e = _(t)), i = e.length; i--;) s = y(e[i]), s[M] ? n.push(s) : o.push(s);
                s = q(t, b(o, n)), s.selector = t
            }
            return s
        }, E = e.select = function (t, e, i, n) {
            var o, s, r, a, l, c = "function" == typeof t && t, h = !n && _(t = c.selector || t);
            if (i = i || [], 1 === h.length) {
                if (s = h[0] = h[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && x.getById && 9 === e.nodeType && O && C.relative[s[1].type]) {
                    if (e = (C.find.ID(r.matches[0].replace(xt, Ct), e) || [])[0], !e) return i;
                    c && (e = e.parentNode), t = t.slice(s.shift().value.length)
                }
                for (o = ft.needsContext.test(t) ? 0 : s.length; o-- && (r = s[o], !C.relative[a = r.type]);) if ((l = C.find[a]) && (n = l(r.matches[0].replace(xt, Ct), bt.test(s[0].type) && d(e.parentNode) || e))) {
                    if (s.splice(o, 1), t = n.length && u(s), !t) return G.apply(i, n), i;
                    break
                }
            }
            return (c || $(t, h))(n, e, !O, i, bt.test(t) && d(e.parentNode) || e), i
        }, x.sortStable = M.split("").sort(V).join("") === M, x.detectDuplicates = !!A, I(), x.sortDetached = o(function (t) {
    ...
    var dt = ot.expr.match.needsContext, ht = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ut = /^.[^:#\[\.,]*$/;
    ot.filter = function (t, e, i) {
        ...
        find: function (t) {
            ...
            if ("string" != typeof t) return this.pushStack(ot(t).filter(function () {
                for (e = 0; o > e; e++) if (ot.contains(n[e], this)) return !0
            }));
    ...
    var pt, ft = t.document, mt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = ot.fn.init = function (t, e) {
        ...
        if ("string" == typeof t) {
            ...
            if (i[1]) {
                if (e = e instanceof ot ? e[0] : e, ot.merge(this, ot.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : ft, !0)), ht.test(i[1]) && ot.isPlainObject(e)) for (i in e) ot.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this
            }
    ...
    ot.extend({
        ...
        has: function (t) {
            ...
            for (var i, n = 0, o = this.length, s = [], r = dt.test(t) || "string" != typeof t ? ot(t, e || this.context) : 0; o > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && ot.find.matchesSelector(i, t))) {
                s.push(i);
                break
            }
    ...
    ot.Callbacks = function (t) {
        ...
        var e, i, n, o, r, a, l = [], c = !t.once && [], d = function (s) {
            ...
            add: function () {
                ...
                return l && ot.each(arguments, function (t, i) {
                    for (var n; (n = ot.inArray(i, l, n)) > -1;) l.splice(n, 1), e && (o >= n && o--, r >= n && r--)
                }), this
            }, has: function (t) {
        ...
        Deferred: function (t) {
            ...
            var e, i, n, o = 0, s = X.call(arguments), r = s.length,
                a = 1 !== r || t && ot.isFunction(t.promise) ? r : 0, l = 1 === a ? t : ot.Deferred(),
                c = function (t, i, n) {
                    return function (o) {
                        i[t] = this, n[t] = arguments.length > 1 ? X.call(arguments) : o, n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n)
                    }
                };
            if (r > 1) for (e = new Array(r), i = new Array(r), n = new Array(r); r > o; o++) s[o] && ot.isFunction(s[o].promise) ? s[o].promise().done(c(o, n, s)).fail(l.reject).progress(c(o, i, e)) : --a;
    ...
    var $t = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Et = ["Top", "Right", "Bottom", "Left"],
        St = function (t, e) {
            return t = e || t, "none" === ot.css(t, "display") || !ot.contains(t.ownerDocument, t)
        }, Dt = ot.access = function (t, e, i, n, o, s, r) {
    ...
    var It = /^(?:input|select|textarea)$/i, Nt = /^key/, Ft = /^(?:mouse|pointer|contextmenu)|click/,
        Ot = /^(?:focusinfocus|focusoutblur)$/, jt = /^([^.]*)(?:\.(.+)|)$/;
    ot.event = {
        global: {},
        add: function (t, e, i, n, o) {
            ...
            if (g) {
                for (i.handler && (l = i, i = l.handler, o = l.selector), i.guid || (i.guid = ot.guid++), (r = g.events) || (r = g.events = {}), (d = g.handle) || (d = g.handle = function (t) {
                    return typeof ot === Tt || t && ot.event.triggered === t.type ? void 0 : ot.event.dispatch.apply(d.elem, arguments)
                }, d.elem = t), e = (e || "").match(bt) || [""], a = e.length; a--;) s = jt.exec(e[a]) || [], p = m = s[1], f = (s[2] || "").split(".").sort(), p && (c = ot.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = ot.event.special[p] || {}, h = ot.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, l), (u = r[p]) || (u = r[p] = [], u.delegateCount = 0, c.setup && c.setup.call(t, n, f, d) !== !1 || (t.addEventListener ? t.addEventListener(p, d, !1) : t.attachEvent && t.attachEvent("on" + p, d))), c.add && (c.add.call(t, h), h.handler.guid || (h.handler.guid = i.guid)), o ? u.splice(u.delegateCount++, 0, h) : u.push(h), ot.event.global[p] = !0);
                t = null
            }
        },
        remove: function (t, e, i, n, o) {
            ...
            if (g && (d = g.events)) {
                for (e = (e || "").match(bt) || [""], c = e.length; c--;) if (a = jt.exec(e[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
        ...
        dispatch: function (t) {
            t = ot.event.fix(t);
            var e, i, n, o, s, r = [], a = X.call(arguments), l = (ot._data(this, "events") || {})[t.type] || [],
        ...
        fix: function (t) {
            ...
            for (r || (this.fixHooks[o] = r = Ft.test(o) ? this.mouseHooks : Nt.test(o) ? this.keyHooks : {}), n = r.props ? this.props.concat(r.props) : this.props, t = new ot.Event(s), e = n.length; e--;) i = n[e], t[i] = s[i];
    ...
    var Pt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Lt = / jQuery\d+="(?:null|\d+)"/g, Rt = new RegExp("<(?:" + Pt + ")[\\s/>]", "i"), Mt = /^\s+/,
        zt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ht = /<([\w:]+)/,
        Ut = /<tbody/i, Wt = /<|&#?\w+;/, Bt = /<(?:script|style|link)/i, qt = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Vt = /^$|\/(?:java|ecma)script/i, Qt = /^true\/(.*)/, Yt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Xt = {
        ...
        }, Kt = m(ft), Zt = Kt.appendChild(ft.createElement("div"));
    Xt.optgroup = Xt.option, Xt.tbody = Xt.tfoot = Xt.colgroup = Xt.caption = Xt.thead, Xt.th = Xt.td, ot.extend({
        clone: function (t, e, i) {
            ...
            if (it.html5Clone || ot.isXMLDoc(t) || !Rt.test("<" + t.nodeName + ">") ? s = t.cloneNode(!0) : (Zt.innerHTML = t.outerHTML, Zt.removeChild(s = Zt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t))) for (n = g(s), a = g(t), r = 0; null != (o = a[r]); ++r) n[r] && T(o, n[r]);
            if (e) if (i) for (a = a || g(t), n = n || g(s), r = 0; null != (o = a[r]); r++) C(o, n[r]); else C(t, s);
            return n = g(s, "script"), n.length > 0 && x(n, !l && g(t, "script")), n = a = o = null, s
        }, buildFragment: function (t, e, i, n) {
            for (var o, s, r, a, l, c, d, h = t.length, u = m(e), p = [], f = 0; h > f; f++) if (s = t[f], s || 0 === s) if ("object" === ot.type(s)) ot.merge(p, s.nodeType ? [s] : s); else if (Wt.test(s)) {
                for (a = a || u.appendChild(e.createElement("div")), l = (Ht.exec(s) || ["", ""])[1].toLowerCase(), d = Xt[l] || Xt._default, a.innerHTML = d[1] + s.replace(zt, "<$1></$2>") + d[2], o = d[0]; o--;) a = a.lastChild;
                if (!it.leadingWhitespace && Mt.test(s) && p.push(e.createTextNode(Mt.exec(s)[0])), !it.tbody) for (s = "table" !== l || Ut.test(s) ? "<table>" !== d[1] || Ut.test(s) ? 0 : a : a.firstChild, o = s && s.childNodes.length; o--;) ot.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
                for (ot.merge(p, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
                a = u.lastChild
            } else p.push(e.createTextNode(s));
            for (a && u.removeChild(a), it.appendChecked || ot.grep(g(p, "input"), v), f = 0; s = p[f++];) if ((!n || -1 === ot.inArray(s, n)) && (r = ot.contains(s.ownerDocument, s), a = g(u.appendChild(s), "script"), r && x(a), i)) for (o = 0; s = a[o++];) Vt.test(s.type || "") && i.push(s);
            return a = null, u
        }, cleanData: function (t, e) {
            for (var i, n, o, s, r = 0, a = ot.expando, l = ot.cache, c = it.deleteExpando, d = ot.event.special; null != (i = t[r]); r++) if ((e || ot.acceptData(i)) && (o = i[a], s = o && l[o])) {
                if (s.events) for (n in s.events) d[n] ? ot.event.remove(i, n) : ot.removeEvent(i, n, s.handle);
                l[o] && (delete l[o], c ? delete i[a] : typeof i.removeAttribute !== Tt ? i.removeAttribute(a) : i[a] = null, Y.push(o))
            }
        }
    }), ot.fn.extend({
        text: function (t) {
            ...
            for (var i, n = t ? ot.filter(t, this) : this, o = 0; null != (i = n[o]); o++) e || 1 !== i.nodeType || ot.cleanData(g(i)), i.parentNode && (e && ot.contains(i.ownerDocument, i) && x(g(i, "script")), i.parentNode.removeChild(i));
            return this
        }, empty: function () {
            ...
            return Dt(this, function (t) {
                ...
                if ("string" == typeof t && !Bt.test(t) && (it.htmlSerialize || !Rt.test(t)) && (it.leadingWhitespace || !Mt.test(t)) && !Xt[(Ht.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = t.replace(zt, "<$1></$2>");
                    try {
            ...
            t = K.apply([], t);
            var i, n, o, s, r, a, l = 0, c = this.length, d = this, h = c - 1, u = t[0], p = ot.isFunction(u);
            if (p || c > 1 && "string" == typeof u && !it.checkClone && qt.test(u)) return this.each(function (i) {
                var n = d.eq(i);
            ...
            if (c && (a = ot.buildFragment(t, this[0].ownerDocument, !1, this), i = a.firstChild, 1 === a.childNodes.length && (a = i), i)) {
                ...
                if (o) for (r = s[s.length - 1].ownerDocument, ot.map(s, w), l = 0; o > l; l++) n = s[l], Vt.test(n.type || "") && !ot._data(n, "globalEval") && ot.contains(r, n) && (n.src ? ot._evalUrl && ot._evalUrl(n.src) : ot.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Yt, "")));
                a = i = null
            }
            return this
        }
        ...
        ot.fn[t] = function (t) {
            for (var i, n = 0, o = [], s = ot(t), r = s.length - 1; r >= n; n++) i = n === r ? this : this.clone(!0), ot(s[n])[e](i), Z.apply(o, i.get());
    ...
    var te, ee, ie = /^margin/, ne = new RegExp("^(" + $t + ")(?!px)[a-z%]+$", "i"), oe = /^(top|right|bottom|left)$/;
    ...
    var se = /alpha\([^)]*\)/i, re = /opacity\s*=\s*([^)]*)/, ae = /^(none|table(?!-c[ea]).+)/,
        le = new RegExp("^(" + $t + ")(.*)$", "i"), ce = new RegExp("^([+-])=(" + $t + ")", "i"),
        de = {position: "absolute", visibility: "hidden", display: "block"},
        he = {letterSpacing: "0", fontWeight: "400"}, ue = ["Webkit", "O", "Moz", "ms"];
    ot.extend({
        cssHooks: {
            opacity: {
                get: function (t, e) {
        ...
        style: function (t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (e = ot.cssProps[a] || (ot.cssProps[a] = E(l, a)), r = ot.cssHooks[e] || ot.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (o = r.get(t, !1, n)) ? o : l[e];
        ...
        css: function (t, e, i, n) {
            ...
            return e = ot.cssProps[a] || (ot.cssProps[a] = E(t.style, a)), r = ot.cssHooks[e] || ot.cssHooks[a], r && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = ee(t, e, n)), "normal" === s && e in he && (s = he[e]), "" === i || i ? (o = parseFloat(s), i === !0 || ot.isNumeric(o) ? o || 0 : s) : s
        }
        ...
        ot.cssHooks[e] = {
            get: function (t, i, n) {
                ...
                var o = n && te(t);
                return D(t, i, n ? A(t, e, n, it.boxSizing && "border-box" === ot.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        ot.cssHooks[t + e] = {
            expand: function (i) {
                for (var n = 0, o = {}, s = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) o[t + Et[n] + e] = s[n] || s[n - 2] || s[0];
                return o
            }
        ...
        constructor: N, init: function (t, e, i, n, o, s) {
    ...
    var pe, fe, me = /^(?:toggle|show|hide)$/, ge = new RegExp("^(?:([+-])=|)(" + $t + ")([a-z%]*)$", "i"),
        ve = /queueHooks$/, ye = [P], be = {
            "*": [function (t, e) {
                var i = this.createTween(t, e), n = i.cur(), o = ge.exec(e), s = o && o[3] || (ot.cssNumber[t] ? "" : "px"),
                    r = (ot.cssNumber[t] || "px" !== s && +n) && ge.exec(ot.css(i.elem, t)), a = 1, l = 20;
                if (r && r[3] !== s) {
                    s = s || r[3], o = o || [], r = +n || 1;
    ...
    ot.fn.extend({
        val: function (t) {
            ...
            })) : o ? (e = ot.valHooks[o.type] || ot.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : (i = o.value, "string" == typeof i ? i.replace(we, "") : null == i ? "" : i)) : void 0
        }
    }), ot.extend({
        valHooks: {
            option: {
                ...
                get: function (t) {
                    for (var e, i, n = t.options, o = t.selectedIndex, s = "select-one" === t.type || 0 > o, r = s ? null : [], a = s ? o + 1 : n.length, l = 0 > o ? a : s ? o : 0; a > l; l++) if (i = n[l], (i.selected || l === o) && (it.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !ot.nodeName(i.parentNode, "optgroup"))) {
    ...
    var xe, Ce, Te = ot.expr.attrHandle, ke = /^(?:checked|selected)$/i, _e = it.getSetAttribute, $e = it.input;
    ot.fn.extend({
        attr: function (t, e) {
        ...
        attr: function (t, e, i) {
            ...
            if (t && 3 !== s && 8 !== s && 2 !== s) return typeof t.getAttribute === Tt ? ot.prop(t, e, i) : (1 === s && ot.isXMLDoc(t) || (e = e.toLowerCase(), n = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? Ce : xe)), void 0 === i ? n && "get" in n && null !== (o = n.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? void 0 : o) : null !== i ? n && "set" in n && void 0 !== (o = n.set(t, i, e)) ? o : (t.setAttribute(e, i + ""), i) : void ot.removeAttr(t, e))
        }, removeAttr: function (t, e) {
            var i, n, o = 0, s = e && e.match(bt);
            if (s && 1 === t.nodeType) for (; i = s[o++];) n = ot.propFix[i] || i, ot.expr.match.bool.test(i) ? $e && _e || !ke.test(i) ? t[n] = !1 : t[ot.camelCase("default-" + i)] = t[n] = !1 : ot.attr(t, i, ""), t.removeAttribute(_e ? i : n)
        }, attrHooks: {
            type: {
                set: function (t, e) {
        ...
        set: function (t, e, i) {
            return e === !1 ? ot.removeAttr(t, i) : $e && _e || !ke.test(i) ? t.setAttribute(!_e && ot.propFix[i] || i, i) : t[ot.camelCase("default-" + i)] = t[i] = !0, i
        }
    }, ot.each(ot.expr.match.bool.source.match(/\w+/g), function (t, e) {
        var i = Te[e] || ot.find.attr;
        Te[e] = $e && _e || !ke.test(e) ? function (t, e, n) {
            var o, s;
            return n || (s = Te[e], Te[e] = o, o = null != i(t, e, n) ? e.toLowerCase() : null, Te[e] = s), o
        } : function (t, e, i) {
            return i ? void 0 : t[ot.camelCase("default-" + e)] ? e.toLowerCase() : null
        }
    }), $e && _e || (ot.attrHooks.value = {
        set: function (t, e, i) {
            return ot.nodeName(t, "input") ? void (t.defaultValue = e) : xe && xe.set(t, e, i)
        }
    }), _e || (xe = {
        set: function (t, e, i) {
    ...
    ot.fn.extend({
        addClass: function (t) {
            ...
            if (c) for (e = (t || "").match(bt) || []; l > a; a++) if (i = this[a], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(De, " ") : " ")) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function (i) {
                ...
                if ("string" === i) for (var e, n = 0, o = ot(this), s = t.match(bt) || []; e = s[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else (i === Tt || "boolean" === i) && (this.className && ot._data(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ot._data(this, "__className__") || "")
            })
        }, hasClass: function (t) {
    ...
    ot.parseJSON = function (e) {
        ...
        return o && !ot.trim(o.replace(Ne, function (t, e, o, s) {
    ...
    var Fe, Oe, je = /#.*$/, Pe = /([?&])_=[^&]*/, Le = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Re = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Me = /^(?:GET|HEAD)$/, ze = /^\/\//,
        He = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Ue = {}, We = {}, Be = "*/".concat("*");
    try {
        Oe = location.href
    } catch (t) {
        Oe = ft.createElement("a"), Oe.href = "", Oe = Oe.href
    }
    Fe = He.exec(Oe.toLowerCase()) || [], ot.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, e) {
            function i(t, e, i, n) {
                var o, d, v, y, w, C = e;
                2 !== b && (b = 2, a && clearTimeout(a), c = void 0, r = n || "", x.readyState = t > 0 ? 4 : 0, o = t >= 200 && 300 > t || 304 === t, i && (y = U(h, x, i)), y = W(h, y, x, o), o ? (h.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (ot.lastModified[s] = w), w = x.getResponseHeader("etag"), w && (ot.etag[s] = w)), 204 === t || "HEAD" === h.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = y.state, d = y.data, v = y.error, o = !v)) : (v = C, (t || !C) && (C = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || C) + "", o ? f.resolveWith(u, [d, C, x]) : f.rejectWith(u, [x, C, v]), x.statusCode(g), g = void 0, l && p.trigger(o ? "ajaxSuccess" : "ajaxError", [x, h, o ? d : v]), m.fireWith(u, [x, C]), l && (p.trigger("ajaxComplete", [x, h]), --ot.active || ot.event.trigger("ajaxStop")))
            }

            "object" == typeof t && (e = t, t = void 0), e = e || {};
            var n, o, s, r, a, l, c, d, h = ot.ajaxSetup({}, e), u = h.context || h,
                p = h.context && (u.nodeType || u.jquery) ? ot(u) : ot.event, f = ot.Deferred(),
                m = ot.Callbacks("once memory"), g = h.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                    readyState: 0, getResponseHeader: function (t) {
                        var e;
                        if (2 === b) {
                            if (!d) for (d = {}; e = Le.exec(r);) d[e[1].toLowerCase()] = e[2];
                            e = d[t.toLowerCase()]
                        }
            ...
            if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, h.url = ((t || h.url || Oe) + "").replace(je, "").replace(ze, Fe[1] + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = ot.trim(h.dataType || "*").toLowerCase().match(bt) || [""], null == h.crossDomain && (n = He.exec(h.url.toLowerCase()), h.crossDomain = !(!n || n[1] === Fe[1] && n[2] === Fe[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Fe[3] || ("http:" === Fe[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = ot.param(h.data, h.traditional)), z(Ue, h, e, x), 2 === b) return x;
            l = ot.event && h.global, l && 0 === ot.active++ && ot.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Me.test(h.type), s = h.url, h.hasContent || (h.data && (s = h.url += (Ie.test(s) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = Pe.test(s) ? s.replace(Pe, "$1_=" + Ae++) : s + (Ie.test(s) ? "&" : "?") + "_=" + Ae++)), h.ifModified && (ot.lastModified[s] && x.setRequestHeader("If-Modified-Since", ot.lastModified[s]), ot.etag[s] && x.setRequestHeader("If-None-Match", ot.etag[s])), (h.data && h.hasContent && h.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", h.contentType), x.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Be + "; q=0.01" : "") : h.accepts["*"]);
            for (o in h.headers) x.setRequestHeader(o, h.headers[o]);
            if (h.beforeSend && (h.beforeSend.call(u, x, h) === !1 || 2 === b)) return x.abort();
            w = "abort";
    ...
    ot.param = function (t, e) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !ot(this).is(":disabled") && Xe.test(this.nodeName) && !Ye.test(t) && (this.checked || !At.test(t))
            }).map(function (t, e) {
                var i = ot(this).val();
    ...
    var Ke = 0, Ze = {}, Ge = ot.ajaxSettings.xhr();
    t.attachEvent && t.attachEvent("onunload", function () {
        for (var t in Ze) Ze[t](void 0, !0)
    }), it.cors = !!Ge && "withCredentials" in Ge, Ge = it.ajax = !!Ge, Ge && ot.ajaxTransport(function (t) {
    ...
    ot.ajaxSetup({
        jsonp: "callback", jsonpCallback: function () {
            var t = Je.pop() || ot.expando + "_" + Ae++;
            return this[t] = !0, t
        }
    }), ot.ajaxPrefilter("json jsonp", function (e, i, n) {
        var o, s, r,
            a = e.jsonp !== !1 && (ti.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && ti.test(e.data) && "data");
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(ti, "$1" + o) : e.jsonp !== !1 && (e.url += (Ie.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return r || ot.error(o + " was not called"), r[0]
        }, e.dataTypes[0] = "json", s = t[o], t[o] = function () {
            r = arguments
        }, n.always(function () {
            t[o] = s, e[o] && (e.jsonpCallback = i.jsonpCallback, Je.push(o)), r && ot.isFunction(s) && s(r[0]), r = s = void 0
        }), "script") : void 0
    ...
    ot.offset = {
        setOffset: function (t, e, i) {
            var n, o, s, r, a, l, c, d = ot.css(t, "position"), h = ot(t), u = {};
        ...
        offset: function (t) {
            ...
            return s ? (e = s.documentElement, ot.contains(e, o) ? (typeof o.getBoundingClientRect !== Tt && (n = o.getBoundingClientRect()), i = Q(s), {
            ...
            return this.map(function () {
                for (var t = this.offsetParent || ii; t && !ot.nodeName(t, "html") && "static" === ot.css(t, "position");) t = t.offsetParent;
                return t || ii
            })
        }
    ...
    var ni = t.jQuery, oi = t.$;
    return ot.noConflict = function (e) {
        return t.$ === ot && (t.$ = oi), e && t.jQuery === ot && (t.jQuery = ni), ot
    ...
    t.fn.extend({
        scrollable: function (t) {
            ...
            if (i = i || {}, "options" === i) return n ? this.each(function () {
                var e = t(this), i = t.extend(e.data("ssOpts") || {}, n);
                t(this).data("ssOpts", i)
            }) : this.first().data("ssOpts");
            var o = t.extend({}, t.fn.smoothScroll.defaults, i), s = t.smoothScroll.filterPath(location.pathname);
            return this.unbind("click.smoothscroll").bind("click.smoothscroll", function (i) {
                var n = this, r = t(this), a = t.extend({}, o, r.data("ssOpts") || {}), l = o.exclude,
                    c = a.excludeWithin, d = 0, h = 0, u = !0, p = {},
                    f = location.hostname === n.hostname || !n.hostname,
                    m = a.scrollTarget || (t.smoothScroll.filterPath(n.pathname) || s) === s, g = e(n.hash);
                if (a.scrollTarget || f && m && g) {
                    for (; u && l.length > d;) r.is(e(l[d++])) && (u = !1);
                    for (; u && c.length > h;) r.closest(c[h++]).length && (u = !1)
                } else u = !1;
                u && (a.preventDefault && i.preventDefault(), t.extend(p, a, {
        ...
        var o, s, r, a, l = 0, c = "offset", d = "scrollTop", h = {}, u = {};
        "number" == typeof e ? (o = t.extend({link: null}, t.fn.smoothScroll.defaults, n), r = e) : (o = t.extend({link: null}, t.fn.smoothScroll.defaults, e || {}, n), o.scrollElement && (c = "position", "static" == o.scrollElement.css("position") && o.scrollElement.css("position", "relative"))), d = "left" == o.direction ? "scrollLeft" : d, o.scrollElement ? (s = o.scrollElement, /^(?:HTML|BODY)$/.test(s[0].nodeName) || (l = s[d]())) : s = t("html, body").firstScrollable(o.direction), o.beforeScroll.call(s, o), r = "number" == typeof e ? e : i || t(o.scrollTarget)[c]() && t(o.scrollTarget)[c]()[o.direction] || 0, h[d] = r + l + o.offset, a = o.speed, "auto" === a && (a = h[d] || s.scrollTop(), a /= o.autoCoefficent), u = {
            duration: a,
            easing: o.easing,
            complete: function () {
                o.afterScroll.call(o.link, o)
            }
        }, o.step && (u.step = o.step), s.length ? s.stop().animate(h, u) : o.afterScroll.call(o.link, o)
    ...
    var s = "stellar", r = {
        ...
        }(), d = c("transform"), h = t("<div />", {style: "background:#fff"}).css("background-position-x") !== n,
        u = h ? function (t, e, i) {
    ...
    o.prototype = {
        init: function () {
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function () {
                var i, o, s, r, a, l, c, d, h, u = t(this), p = 0, f = 0, m = 0, g = 0;
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function () {
                var e, r, a, l, c, d, h, f = t(this), m = p(f), g = 0, v = 0, y = 0, b = 0;
                if (f.data("stellar-backgroundIsActive")) {
                    if (f.data("stellar-backgroundIsActive") !== this) return
                } else f.data("stellar-backgroundIsActive", this);
                f.data("stellar-backgroundStartingLeft") ? u(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", m[0]), f.data("stellar-backgroundStartingTop", m[1])), a = "auto" === f.css("margin-left") ? 0 : parseInt(f.css("margin-left"), 10), l = "auto" === f.css("margin-top") ? 0 : parseInt(f.css("margin-top"), 10), c = f.offset().left - a - o, d = f.offset().top - l - s, f.parents().each(function () {
                    var e = t(this);
            ...
            var t, e, i, n, o, s, r, a, l, c, d = this._getScrollLeft(), h = this._getScrollTop(), p = !0, f = !0;
    ...
    i = function (i, n) {
        ...
        var o = this, s = e("<div>", {class: "slides-control"}), r = 1;
        ...
        var a = function () {
            ...
            containers: function () {
                o.init ? (o.$el.css({height: o.height}), o.$control.css({
                    width: o.width * r,
                    left: -o.width
                }), o.$container.css({})) : (e("body").css({margin: 0}), o.$el.css({
                    position: "relative",
                    overflow: "hidden",
                    width: "100%",
                    height: o.height
                ...
                t.removeAttr("width").removeAttr("height").css({
                    ...
                    var t = o.image._aspectRatio(this), i = this;
                    if (e.data(this, "processed")) o.image._scale(i, t), o.image._center(i, t); else {
                        var n = new Image;
                        n.onload = function () {
                ...
                t.is("img") && (t.each(function () {
                    ...
                    display: "none",
                    left: 2 * o.width
                }), t.css({position: "absolute", overflow: "hidden", height: "100%", width: o.width, top: 0, zIndex: 0})
            }
        }, c = {
            slide: function (t, e) {
                var i = o.$container.children(), n = i.eq(t.upcoming_slide);
                n.css({
                    left: t.upcoming_position,
                    display: "block"
                }), o.$control.animate({left: t.offset}, o.options.animation_speed, o.options.animation_easing, function () {
                    o.size() > 1 && (o.$control.css({left: -o.width}), i.eq(t.upcoming_slide).css({
                        left: o.width,
                        zIndex: 2
                ...
                var i = this, n = i.$container.children(), o = n.eq(t.outgoing_slide), s = n.eq(t.upcoming_slide);
                s.css({
                    left: this.width,
                    opacity: 0,
                    display: "block"
                }).animate({opacity: 1}, i.options.animation_speed, i.options.animation_easing), t.outgoing_slide >= 0 ? o.animate({opacity: 0}, i.options.animation_speed, i.options.animation_easing, function () {
                    i.size() > 1 && (n.eq(t.upcoming_slide).css({zIndex: 2}), t.outgoing_slide >= 0 && n.eq(t.outgoing_slide).css({
                        opacity: 1,
                        display: "none",
                        zIndex: 0
                    })), e()
        ...
        var d = {
            ...
            _setCurrent: function (t) {
                ...
                var i = t + 1, n = i, s = o.$container.children().eq(t), r = s.attr("id");
                r && (n = r);
                var a = e("<a>", {href: "#" + n, text: n});
                a.appendTo(o.$pagination)
            }, _setup: function () {
                if (o.options.pagination && 1 !== o.size()) {
                    var t = e("<nav>", {class: o.options.elements.pagination.replace(/^\./, "")});
        ...
        return this.css = l, this.image = d, this.pagination = h, this.fx = c, this.animation = this.fx[this.options.animation], this.$control = this.$container.wrap(s).parent(".slides-control"), o._findPositions(), o.width = o._findWidth(), o.height = o._findHeight(), this.css.children(), this.css.containers(), this.css.images(), this.pagination._setup(), a()
    }, i.prototype = {
        _findWidth: function () {
            ...
            if (!(this.animating || (this.animating = !0, void 0 === e && (e = "next"), o.upcoming_slide = this._upcomingSlide(e), o.upcoming_slide >= this.size()))) {
                if (o.outgoing_slide = this.current, o.upcoming_position = 2 * this.width, o.offset = -o.upcoming_position, ("prev" === e || o.outgoing_slide > e) && (o.upcoming_position = 0, o.offset = 0), n.size() > 1 && n.pagination._setCurrent(o.upcoming_slide), n.options.hashchange) {
                    var s = o.upcoming_slide + 1, r = n.$container.children(":eq(" + o.upcoming_slide + ")").attr("id");
                    t.location.hash = r ? r : s
                }
        ...
        return this.each(function () {
            var r, a, l;
            return r = e(this), a = r.data(n), l = "object" == typeof t && t, a || (s = r.data(n, a = new i(this, l))), "string" == typeof t && (s = a[t], "function" == typeof s) ? s = s.call(a, o) : void 0
        }), s
    }, e.fn[n].fx = {}
    ...
    t.extend(t.fn, {
        validate: function (e) {
            ...
            var n = this[0];
            if (e) {
                var o = t.data(n.form, "validator").settings, s = o.rules, r = t.validator.staticRules(n);
                switch (e) {
                    case"add":
                        t.extend(r, t.validator.normalizeRule(i)), s[n.name] = r, i.messages && (o.messages[n.name] = t.extend(o.messages[n.name], i.messages));
                        break;
                    case"remove":
            ...
            return n = t.validator.normalizeRules(t.extend({}, t.validator.metadataRules(n), t.validator.classRules(n), t.validator.attributeRules(n), t.validator.staticRules(n)), n), n.required && (o = n.required, delete n.required, n = t.extend({required: o}, n)), n
        }
    }), t.extend(t.expr[":"], {
        blank: function (e) {
        ...
        prototype: {
            init: function () {
                function e(e) {
                    var i = t.data(this[0].form, "validator"), n = "on" + e.type.replace(/^validate/, "");
                ...
                var i, n = t(e).rules(), o = !1;
                for (i in n) {
                    var s = {method: i, parameters: n[i]};
                    try {
                        var r = t.validator.methods[i].call(this, e.value.replace(/\r/g, ""), e, s.parameters);
                        if ("dependency-mismatch" == r) o = !0; else {
                            if (o = !1, "pending" == r) return void (this.toHide = this.toHide.not(this.errorsFor(e)));
                            if (!r) return this.formatAndAdd(e, s), !1
                        }
                    } catch (t) {
                        throw this.settings.debug && window.console && console.log("exception occured when checking element " + e.id + ", check the '" + s.method + "' method", t), t
                    }
                }
        ...
        attributeRules: function (e) {
            ...
            for (var n in t.validator.methods) {
                var o;
                (o = "required" === n && "function" == typeof t.fn.prop ? e.prop(n) : e.attr(n)) ? i[n] = o : e[0].getAttribute("type") === n && (i[n] = !0)
            }
        ...
        normalizeRules: function (e, i) {
            return t.each(e, function (n, o) {
                if (o === !1) delete e[n]; else if (o.param || o.depends) {
                    var s = !0;
            ...
            required: function (e, i, n) {
                ...
                return r[i.name] = e, t.ajax(t.extend(!0, {
                    ...
                    success: function (n) {
                        ...
                        } else a = {}, n = n || s.defaultMessage(i, "remote"), a[i.name] = o.message = t.isFunction(n) ? n(e) : n, s.showErrors(a);
                ...
                var i = 0, n = 0, o = !1;
                t = t.replace(/\D/g, "");
                for (var s = t.length - 1; s >= 0; s--) n = t.charAt(s), n = parseInt(n, 10), o && (n *= 2) > 9 && (n -= 9), i += n, o = !o;
                return i % 10 == 0
    ...
    if (t.ajaxPrefilter) t.ajaxPrefilter(function (t, i, n) {
        ...
        t.ajax = function (n) {
            ...
            return "abort" == ("mode" in n ? n : t.ajaxSettings).mode ? (e[o] && e[o].abort(), e[o] = i.apply(this, arguments)) : i.apply(this, arguments)
        }
    }
}(jQuery), function (t) {
    !jQuery.event.special.focusin && !jQuery.event.special.focusout && document.addEventListener && t.each({
        ...
        validateDelegate: function (e, i, n) {
            return this.bind(i, function (i) {
                var o = t(i.target);
                if (o.is(e)) return n.apply(o, arguments)
            })
        }
    })
}(jQuery), $(document).ready(function () {
    $(window).on("scroll", function () {
        ...
        t >= 50 ? ($("#header").addClass("fixed"), t >= 1350 ? $(".upb").css("display", "block") : t <= 550 && $(".upb").css("display", "none")) : $("#header").removeClass("fixed")
    }), $(".flexslider").flexslider({animation: "fade", directionNav: !1});
    var t = $("section");
    nav = $('nav[role="navigation"]'), $(window).on("scroll", function () {
        var e = $(this).scrollTop();
        t.each(function () {
            var t = $(this).offset().top - 76;
            bottom = t + $(this).outerHeight(), e >= t && e <= bottom && (nav.find("a").removeClass("active"), nav.find('a[href="#' + $(this).attr("id") + '"]').addClass("active"))
        })
    }), nav.find("a").on("click", function () {
        var t = $(this);
        return id = t.attr("href"), $("html, body").animate({scrollTop: $(id).offset().top - 75}, 500), !1
    }), $(".nav-toggle").on("click", function () {
        return $(this).toggleClass("close-nav"), nav.toggleClass("open"), !1
    }), nav.find("a").on("click", function () {
        $(".nav-toggle").toggleClass("close-nav"), nav.toggleClass("open")
    })
}), !function (t) {
    ...
    t.mask = {
        ...
        caret: function (t, e) {
            ...
            return r = t.extend({
                ...
                placeholder: t.mask.placeholder,
                completed: null
            }, r), l = t.mask.definitions, c = [], d = p = i.length, h = null, t.each(i.split(""), function (t, e) {
                "?" == e ? (p--, d = t) : l[e] ? (c.push(new RegExp(l[e])), null === h && (h = c.length - 1), d > t && (u = c.length - 1)) : c.push(null)
            }), this.trigger("unmask").each(function () {
                function a() {
                    if (r.completed) {
                        for (var t = h; u >= t; t++) if (c[t] && S[t] === m(t)) return;
                        r.completed.call(E)
                    }
                }
                ...
                function y(t, e) {
                    ...
                    if (!(0 > t)) {
                        for (i = t, n = g(e); p > i; i++) if (c[i]) {
                            if (!(p > n && c[i].test(S[n]))) break;
                            S[i] = S[n], S[n] = m(n), n = g(n)
                        }
                        _(), E.caret(Math.max(h, t))
                    }
                }
                ...
                function b(t) {
                    ...
                    for (e = t, i = m(t); p > e; e++) if (c[e]) {
                        if (n = g(e), o = S[e], S[e] = i, !(p > n && c[n].test(o))) break;
                        i = o
                    }
                }
                ...
                function w() {
                    ...
                    if (f && f.length && f.length > t.length) {
                        ...
                        for ($(!0); e.begin < p && !c[e.begin];) e.begin++;
                        E.caret(e.begin, e.begin)
                    }
                    a()
                }
                ...
                function C(t) {
                    if (!E.prop("readonly")) {
                        ...
                        f = E.val(), 8 === s || 46 === s || n && 127 === s ? (e = E.caret(), i = e.begin, o = e.end, o - i === 0 && (i = 46 !== s ? v(i) : o = g(i - 1), o = 46 === s ? g(o) : o), k(i, o), y(i, o - 1), t.preventDefault()) : 13 === s ? x.call(this, t) : 27 === s && (E.val(A), E.caret(0, $()), t.preventDefault())
                    }
                }
                ...
                function T(e) {
                    if (!E.prop("readonly")) {
                        ...
                        if (!(e.ctrlKey || e.altKey || e.metaKey || 32 > r) && r && 13 !== r) {
                            if (l.end - l.begin !== 0 && (k(l.begin, l.end), y(l.begin, l.end - 1)), i = g(l.begin - 1), p > i && (n = String.fromCharCode(r), c[i].test(n))) {
                                if (b(i), S[i] = n, _(), o = g(i), s) {
                                    var d = function () {
                ...
                function $(t) {
                    ...
                    for (e = 0, n = 0; p > e; e++) if (c[e]) {
                        for (S[e] = m(e); n++ < o.length;) if (i = o.charAt(n - 1), c[e].test(i)) {
                            S[e] = i, s = e;
                            break
                        }
                        if (n > o.length) {
                    ...
                    } else S[e] === o.charAt(n) && n++, d > e && (s = e);
                    return t ? _() : d > s + 1 ? r.autoclear || S.join("") === D ? (E.val() && E.val(""), k(0, p)) : _() : (_(), E.val(E.val().substring(0, s + 1))), d ? e : h
                }

                var E = t(this), S = t.map(i.split(""), function (t, e) {
                ...
                E.data(t.mask.dataName, function () {
                    ...
                    if (!E.prop("readonly")) {
                        clearTimeout(e);
                        var t;
                        A = E.val(), t = $(), e = setTimeout(function () {
                            E.get(0) === document.activeElement && (_(), t == i.replace("?", "").length ? E.caret(0, t) : E.caret(t))
                        }, 10)
                    }
                ...
                }), o && s && E.off("input.mask").on("input.mask", w), $()
            })
        }
    })
}), $("#mc-embedded-subscribe").click(function () {
    setTimeout(function () {
        "Almost finished... We need to confirm your email address. To complete the subscription process, please click the link in the email we just sent you." == $("#mce-success-response")[0].textContent && ($("#mce-success-response")[0].textContent = "Мы получили Вашу заявку. Вам на почту отправлено письмо с запросом на подтверждение.", console.log($("#mce-success-response")[0].textContent))
    }, 400), setTimeout(function () {
        "Too many subscribe attempts for this email address. Please try again in about 5 minutes. (#6592)" == $("#mce-error-response")[0].textContent && ($("#mce-error-response")[0].textContent = "Извините, Вы отправили слишком много запросов", console.log($("#mce-error-response")[0].textContent))
    }, 300)
}) + function (t) {
    "use strict";
    ...
    function c(t, e, i) {
        var n = t.charAt(0).toUpperCase() + t.slice(1), o = (t + " " + _.join(n + " ") + n).split(" ");
        return s(e, "string") || s(e, "undefined") ? a(o, e) : (o = (t + " " + $.join(n + " ") + n).split(" "), l(o, e, i))
    }

    function d() {
        f.input = function (i) {
            for (var n = 0, o = i.length; n < o; n++) A[i[n]] = !!(i[n] in w);
            ...
            for (var n, o, s, r = 0, a = t.length; r < a; r++) w.setAttribute("type", o = t[r]), n = "text" !== w.type, n && (w.value = x, w.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && w.style.WebkitAppearance !== i ? (g.appendChild(w), s = e.defaultView, n = s.getComputedStyle && "textfield" !== s.getComputedStyle(w, null).WebkitAppearance && 0 !== w.offsetHeight, g.removeChild(w)) : /^(search|tel)$/.test(o) || (n = /^(url|email)$/.test(o) ? w.checkValidity && w.checkValidity() === !1 : w.value != x)), D[t[r]] = !!n;
            return D
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }

    var h, u, p = "2.8.3", f = {}, m = !0, g = e.documentElement, v = "modernizr", y = e.createElement(v), b = y.style,
        w = e.createElement("input"), x = ":)", C = {}.toString, T = " -webkit- -moz- -o- -ms- ".split(" "),
        k = "Webkit Moz O ms", _ = k.split(" "), $ = k.toLowerCase().split(" "),
        E = {svg: "http://www.w3.org/2000/svg"}, S = {}, D = {}, A = {}, I = [], N = I.slice,
        F = function (t, i, n, o) {
            var s, r, a, l, c = e.createElement("div"), d = e.body, h = d || e.createElement("body");
            if (parseInt(n, 10)) for (; n--;) a = e.createElement("div"), a.id = o ? o[n] : v + (n + 1), c.appendChild(a);
            return s = ["&#173;", '<style id="s', v, '">', t, "</style>"].join(""), c.id = v, (d ? c : h).innerHTML += s, h.appendChild(c), d || (h.style.background = "", h.style.overflow = "hidden", l = g.style.overflow, g.style.overflow = "hidden", g.appendChild(h)), r = i(c, t), d ? c.parentNode.removeChild(c) : (h.parentNode.removeChild(h), g.style.overflow = l), !!r
        }, O = function (e) {
    ...
    u = s(P, "undefined") || s(P.call, "undefined") ? function (t, e) {
        ...
        var i = N.call(arguments, 1), n = function () {
            if (this instanceof n) {
                ...
                var s = new o, r = e.apply(s, i.concat(N.call(arguments)));
        ...
        var i;
        return "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch ? i = !0 : F(["@media (", T.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (t) {
            i = 9 === t.offsetTop
        }), i
        ...
        return n((t + "-webkit- ".split(" ").join(e + t) + T.join(i + t)).slice(0, -t.length)), r(b.backgroundImage, "gradient")
        ...
        var t = !!c("perspective");
        return t && "webkitPerspective" in g.style && F("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function (e, i) {
        ...
        return !!e.createElementNS && /SVGAnimate/.test(C.call(e.createElementNS(E.svg, "animate")))
    }, S.svgclippaths = function () {
        return !!e.createElementNS && /SVGClipPath/.test(C.call(e.createElementNS(E.svg, "clipPath")))
    };
    for (var L in S) u(S, L) && (h = L.toLowerCase(), f[h] = S[L](), I.push((f[h] ? "" : "no-") + h));
    return f.input || d(), f.addTest = function (t, e) {
        ...
        t.html5 = y, l(e)
    }(this, e), f._version = p, f._prefixes = T, f._domPrefixes = $, f._cssomPrefixes = _, f.mq = O, f.hasEvent = j, f.testProp = function (t) {
        return a([t])
    }, f.testAllProps = c, f.testStyles = F, f.prefixed = function (t, e, i) {
    ...
    o.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, o.prototype.fetch = function (t, e) {
        ...
        var n, o, s, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "",
            a = e.find("img"), l = "src", c = "", d = this._core.settings, h = function (t) {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (h(a.attr(l)), a.remove(), !1) : void ("youtube" === i.type ? (s = "//img.youtube.com/vi/" + i.id + "/hqdefault.jpg", h(s)) : "vimeo" === i.type ? t.ajax({
            type: "GET",
...
}(window.Zepto || window.jQuery, window, document), eval(function (t, e, i, n, o, s) {
    if (o = function (t) {
    ...
    t.Placeholders = {Utils: {addEventListener: e, inArray: i, moveCaret: n, changeType: o}}
}(this), function (t) {
    "use strict";
    ...
    function n(t, e) {
        var i, n, o = !!e && t.value !== e, s = t.value === t.getAttribute(F);
        return !(!o && !s || "true" !== t.getAttribute(O)) && (t.removeAttribute(O), t.value = t.value.replace(t.getAttribute(F), ""), t.className = t.className.replace(N, ""), n = t.getAttribute(z), parseInt(n, 10) >= 0 && (t.setAttribute("maxLength", n), t.removeAttribute(z)), i = t.getAttribute(j), i && (t.type = i), !0)
    }

    function o(t) {
        var e, i, n = t.getAttribute(F);
        return !("" !== t.value || !n) && (t.setAttribute(O, "true"), t.value = n, t.className += " " + I, i = t.getAttribute(z), i || (t.setAttribute(z, t.maxLength), t.removeAttribute("maxLength")), e = t.getAttribute(j), e ? t.type = "text" : "password" === t.type && q.changeType(t, "text") && t.setAttribute(j, "password"), !0)
    }

    function s(t, e) {
        var i, n, o, s, r, a, l;
        if (t && t.getAttribute(F)) e(t); else for (o = t ? t.getElementsByTagName("input") : m, s = t ? t.getElementsByTagName("textarea") : g, i = o ? o.length : 0, n = s ? s.length : 0, l = 0, a = i + n; a > l; l++) r = i > l ? o[l] : s[l - i], e(r)
    }
    ...
    function l(t) {
        return function () {
            v && t.value === t.getAttribute(F) && "true" === t.getAttribute(O) ? q.moveCaret(t, 0) : n(t)
        }
    }
    ...
    function d(t) {
        return function (e) {
            return b = t.value, "true" === t.getAttribute(O) && b === t.getAttribute(F) && q.inArray(D, e.keyCode) ? (e.preventDefault && e.preventDefault(), !1) : void 0
        }
    }
    ...
    function u(t) {
        return function () {
            t === i() && t.value === t.getAttribute(F) && "true" === t.getAttribute(O) && q.moveCaret(t, 0)
        }
    }
    ...
    function f(t) {
        t.form && (k = t.form, "string" == typeof k && (k = document.getElementById(k)), k.getAttribute(P) || (q.addEventListener(k, "submit", p(k)), k.setAttribute(P, "true"))), q.addEventListener(t, "focus", l(t)), q.addEventListener(t, "blur", c(t)), v && (q.addEventListener(t, "keydown", d(t)), q.addEventListener(t, "keyup", h(t)), q.addEventListener(t, "click", u(t))), t.setAttribute(L, "true"), t.setAttribute(F, C), (v || t !== i()) && o(t)
    }

    var m, g, v, y, b, w, x, C, T, k, _, $, E,
        S = ["text", "search", "url", "tel", "email", "password", "number", "textarea"],
        D = [27, 33, 34, 35, 36, 37, 38, 39, 40, 8, 46], A = "#ccc", I = "placeholdersjs",
        N = RegExp("(?:^|\\s)" + I + "(?!\\S)"), F = "data-placeholder-value", O = "data-placeholder-active",
        j = "data-placeholder-type", P = "data-placeholder-submit", L = "data-placeholder-bound",
        R = "data-placeholder-focus", M = "data-placeholder-live", z = "data-placeholder-maxlength",
        H = document.createElement("input"), U = document.getElementsByTagName("head")[0], W = document.documentElement,
        B = t.Placeholders, q = B.Utils;
    if (B.nativeSupport = void 0 !== H.placeholder, !B.nativeSupport) {
        for (m = document.getElementsByTagName("input"), g = document.getElementsByTagName("textarea"), v = "false" === W.getAttribute(R), y = "false" !== W.getAttribute(M), w = document.createElement("style"), w.type = "text/css", x = document.createTextNode("." + I + " { color:" + A + "; }"), w.styleSheet ? w.styleSheet.cssText = x.nodeValue : w.appendChild(x), U.insertBefore(w, U.firstChild), E = 0, $ = m.length + g.length; $ > E; E++) _ = m.length > E ? m[E] : g[E - m.length], C = _.attributes.placeholder, C && (C = C.nodeValue, C && q.inArray(S, _.type) && f(_));
        T = setInterval(function () {
            for (E = 0, $ = m.length + g.length; $ > E; E++) _ = m.length > E ? m[E] : g[E - m.length], C = _.attributes.placeholder, C ? (C = C.nodeValue, C && q.inArray(S, _.type) && (_.getAttribute(L) || f(_), (C !== _.getAttribute(F) || "password" === _.type && !_.getAttribute(j)) && ("password" === _.type && !_.getAttribute(j) && q.changeType(_, "text") && _.setAttribute(j, "password"), _.value === _.getAttribute(F) && (_.value = C), _.setAttribute(F, C)))) : _.getAttribute(O) && (n(_), _.removeAttribute(F));
            y || clearInterval(T)
        }, 100)
    }
    q.addEventListener(t, "beforeunload", function () {
        B.disable()
    }), B.disable = B.nativeSupport ? e : r, B.enable = B.nativeSupport ? e : a
}(this), function (t) {
    "use strict";
    ...
    function i(t, i) {
        if (this.path = t || "", "undefined" != typeof i && null !== i) this.at_2x_path = i, this.perform_check = !1; else {
    ...
    o.Retina = t, t.configure = function (t) {
        ...
        t.onload = function () {
            var t, i, o = document.getElementsByTagName("img"), s = [];
    ...
    jQuery.fn.exists = function () {
        ...
        if (!is_mobile() && (t("#user_phone").exists() && (t("#user_phone").each(function () {
            t(this).mask("+38 (999) 999-99-99")
        }), t("#user_phone").addClass("rfield").removeAttr("required").removeAttr("pattern").removeAttr("title").attr({placeholder: "Номер Вашего телефона..."})), t("#cform").exists())) {
            var e = t("#cform"), i = e.find(".btn_submit");
            e.find(".rfield").addClass("empty_field"), setInterval(function () {
                if (t("#user_phone").exists()) {
                    var n = t("#user_phone");
                    n.val().indexOf("_") != -1 || "" == n.val() ? n.addClass("empty_field") : n.removeClass("empty_field")
                }
                var o = e.find(".empty_field").size();
    ...
    jQuery.fn.exists = function () {
        ...
        if (!is_mobile() && (t("#user_phone2").exists() && (t("#user_phone2").each(function () {
            t(this).mask("+38 (999) 999-99-99")
        }), t("#user_phone2").addClass("rfield").removeAttr("required").removeAttr("pattern").removeAttr("title").attr({placeholder: "Номер Вашего телефона..."})), t("#cform2").exists())) {
            var e = t("#cform2"), i = e.find(".btn_submit");
            e.find(".rfield").addClass("empty_field"), setInterval(function () {
                if (t("#user_phone2").exists()) {
                    var n = t("#user_phone2");
                    n.val().indexOf("_") != -1 || "" == n.val() ? n.addClass("empty_field") : n.removeClass("empty_field")
                }
                var o = e.find(".empty_field").size();
